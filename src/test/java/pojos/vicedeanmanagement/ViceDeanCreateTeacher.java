...
public class ViceDeanCreateTeacher {
    ...
    public ViceDeanCreateTeacher() {
    }

    public ViceDeanCreateTeacher(String birthDay,
                                 String birthPlace,
                                 String email,
                                 String gender,
                                 boolean isAdvisorTeacher,
                                 List<Integer> lessonsIdList,
                                 String name,
                                 String password,
                                 String phoneNumber,
                                 String ssn,
