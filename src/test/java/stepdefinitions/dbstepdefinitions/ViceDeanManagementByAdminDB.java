...
public class ViceDeanManagementByAdminDB {

    Connection connection;
    Statement statement;
    ResultSet resultSet;
    @When("user sends the query with the id to the database")
    public void user_sends_the_query_with_the_id_to_the_database() {
    ...
    public void user_verifies_the_vice_dean_account_can_be_created_by_admin() {
        try {
