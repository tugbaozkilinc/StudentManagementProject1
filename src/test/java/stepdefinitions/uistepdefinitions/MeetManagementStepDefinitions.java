...
mainMenu.meetManagement.click();
    ...
    public void user_choses_the_student_from_the_choose_student_dropdown() throws InterruptedException {
        wait(2);
meetManagement.chooseStudentTextBox.isSelected();
    ...
    public void user_sees_that_the_green_confirmation_text_appeared_on_the_page(String string) {
        ...
        Assert.assertEquals("Student saved Successfully", meetManagement.alertMessage.getText());
    ...
    public void user_click_delete_button_of_any_meet_in_meet_list() {
        meetManagement.deleteButton.click();
