...
//        Assert.assertEquals("Student saved Successfully", actualData.getMessage());
    ...
    public void user_sends_get_request_and_do_the_assertion_for_getting_student_by_vice_dean() {
        ...
        response = given(spec).body(expectedData).when().get("/{first}/{second}");
...
//    public void userSendsThePOSTRequestToCreateStudentAsViceDean()
//    }

//    @Then("user do assertion as vice dean to verify student creation")
//    public void userDoAssertionAsViceDeanToVerifyStudentCreation() {
//    }
}
